...
generalActorVar <- .7
generalPartnerVar <- .3
generalRelationshipVar <- 1
generalActorPartnerCov <- .2749545  #(implying correlation of .6)
generalRelationshipCov <- .5        #(implying correlation of .5)
...
differentActorVar <- .7
differentPartnerVar <- .3
differentRelationshipVar <- 1
differentActorPartnerCov <- .2749545  #(implying correlation of .6)
differentRelationshipCov <- .5        #(implying correlation of .5)
...
av5different <- mxModel("av5different",
                        type="RAM",
                        manifestVars = c(
                          "xab1",
                          "xac1",
...
av13different <- mxModel("av13different",
                         type="RAM",
                         manifestVars = c(
                           "xab1",
                           "xac1",
...
pv5different <- mxModel("pv5different",
                        type="RAM",
                        manifestVars = c(
                          "xab1",
                          "xac1",
...
pv13different <- mxModel("pv13different",
                         type="RAM",
                         manifestVars = c(
                           "xab1",
                           "xac1",
...
rv5different <- mxModel("rv5different",
                        type="RAM",
                        manifestVars = c(
                          "xab1",
                          "xac1",
...
rv13different <- mxModel("rv13different",
                         type="RAM",
                         manifestVars = c(
                           "xab1",
                           "xac1",
...
#1vs5 groups, groupsize 5, different, av

hvector1vs5gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1],], type="raw")), mxModel(av5different, mxData(PopDifferent[random[2:6],], type="raw")),
                         mxFitFunctionMultigroup(c("base5", "av5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector1vs5gs5different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector1vs5gs5different_av[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector1vs5gs5different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector1vs5gs5different_av[i] <- -9999
  }
  else {
    hvector1vs5gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector1vs5gs5different_av, file = "hvector1vs5gs5different_av.rda")
...
#1vs5 groups, groupsize 5, different, pv

hvector1vs5gs5different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1],], type="raw")), mxModel(pv5different, mxData(PopDifferent[random[2:6],], type="raw")),
                         mxFitFunctionMultigroup(c("base5", "pv5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector1vs5gs5different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector1vs5gs5different_pv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector1vs5gs5different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector1vs5gs5different_pv[i] <- -9999
  }
  else {
    hvector1vs5gs5different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector1vs5gs5different_pv, file = "hvector1vs5gs5different_pv.rda")
...
#1vs5 groups, groupsize 13, different, av

hvector1vs5gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base13, mxData(PopSame[random[1],], type="raw")), mxModel(av13different, mxData(PopDifferent[random[2:6],], type="raw")),
                         mxFitFunctionMultigroup(c("base13", "av13different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector1vs5gs13different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector1vs5gs13different_av[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector1vs5gs13different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector1vs5gs13different_av[i] <- -9999
  }
  else {
    hvector1vs5gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector1vs5gs13different_av, file = "hvector1vs5gs13different_av.rda")
...
#1vs5 groups, groupsize 13, different, pv

hvector1vs5gs13different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base13, mxData(PopSame[random[1],], type="raw")), mxModel(pv13different, mxData(PopDifferent[random[2:6],], type="raw")),
                         mxFitFunctionMultigroup(c("base13", "pv13different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector1vs5gs13different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector1vs5gs13different_pv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector1vs5gs13different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector1vs5gs13different_pv[i] <- -9999
  }
  else {
    hvector1vs5gs13different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector1vs5gs13different_pv, file = "hvector1vs5gs13different_pv.rda")
...
#5vs5 groups, groupsize 5, different, av

hvector5vs5gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1:5],], type="raw")), mxModel(av5different, mxData(PopDifferent[random[6:10],], type="raw")),
                         mxFitFunctionMultigroup(c("base5", "av5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector5vs5gs5different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector5vs5gs5different_av[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector5vs5gs5different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector5vs5gs5different_av[i] <- -9999
  }
  else {
    hvector5vs5gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector5vs5gs5different_av, file = "hvector5vs5gs5different_av.rda")
...
#5vs5 groups, groupsize 5, different, pv

hvector5vs5gs5different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1:5],], type="raw")), mxModel(pv5different, mxData(PopDifferent[random[6:10],], type="raw")),
                         mxFitFunctionMultigroup(c("base5", "pv5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector5vs5gs5different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector5vs5gs5different_pv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector5vs5gs5different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector5vs5gs5different_pv[i] <- -9999
  }
  else {
    hvector5vs5gs5different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector5vs5gs5different_pv, file = "hvector5vs5gs5different_pv.rda")
...
#5vs5 groups, groupsize 13, different, av

hvector5vs5gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base13, mxData(PopSame[random[1:5],], type="raw")), mxModel(av13different, mxData(PopDifferent[random[6:10],], type="raw")),
                         mxFitFunctionMultigroup(c("base13", "av13different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector5vs5gs13different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector5vs5gs13different_av[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector5vs5gs13different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector5vs5gs13different_av[i] <- -9999
  }
  else {
    hvector5vs5gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector5vs5gs13different_av, file = "hvector5vs5gs13different_av.rda")
...
#5vs5 groups, groupsize 13, different, pv

hvector5vs5gs13different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base13, mxData(PopSame[random[1:5],], type="raw")), mxModel(pv13different, mxData(PopDifferent[random[6:10],], type="raw")),
                         mxFitFunctionMultigroup(c("base13", "pv13different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector5vs5gs13different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector5vs5gs13different_pv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector5vs5gs13different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector5vs5gs13different_pv[i] <- -9999
  }
  else {
    hvector5vs5gs13different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector5vs5gs13different_pv, file = "hvector5vs5gs13different_pv.rda")
...
#10vs10 groups, groupsize 5, different, av

hvector10vs10gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1:10],], type="raw")), mxModel(av5different, mxData(PopDifferent[random[11:20],], type="raw")),
                         mxFitFunctionMultigroup(c("base5", "av5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector10vs10gs5different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector10vs10gs5different_av[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector10vs10gs5different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector10vs10gs5different_av[i] <- -9999
  }
  else {
    hvector10vs10gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector10vs10gs5different_av, file = "hvector10vs10gs5different_av.rda")
...
#10vs10 groups, groupsize 5, different, pv

hvector10vs10gs5different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1:10],], type="raw")), mxModel(pv5different, mxData(PopDifferent[random[11:20],], type="raw")),
                         mxFitFunctionMultigroup(c("base5", "pv5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector10vs10gs5different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector10vs10gs5different_pv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector10vs10gs5different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector10vs10gs5different_pv[i] <- -9999
  }
  else {
    hvector10vs10gs5different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector10vs10gs5different_pv, file = "hvector10vs10gs5different_pv.rda")
...
#10vs10 groups, groupsize 13, different, av

hvector10vs10gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base13, mxData(PopSame[random[1:10],], type="raw")), mxModel(av13different, mxData(PopDifferent[random[11:20],], type="raw")),
                         mxFitFunctionMultigroup(c("base13", "av13different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector10vs10gs13different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector10vs10gs13different_av[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector10vs10gs13different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector10vs10gs13different_av[i] <- -9999
  }
  else {
    hvector10vs10gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector10vs10gs13different_av, file = "hvector10vs10gs13different_av.rda")
...
#10vs10 groups, groupsize 13, different, pv

hvector10vs10gs13different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base13, mxData(PopSame[random[1:10],], type="raw")), mxModel(pv13different, mxData(PopDifferent[random[11:20],], type="raw")),
                         mxFitFunctionMultigroup(c("base13", "pv13different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector10vs10gs13different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector10vs10gs13different_pv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector10vs10gs13different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector10vs10gs13different_pv[i] <- -9999
  }
  else {
    hvector10vs10gs13different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector10vs10gs13different_pv, file = "hvector10vs10gs13different_pv.rda")
...
#20vs20 groups, groupsize 5, different, av

hvector20vs20gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1:20],], type="raw")), mxModel(av5different, mxData(PopDifferent[random[21:40],], type="raw")),
                         mxFitFunctionMultigroup(c("base5", "av5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector20vs20gs5different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector20vs20gs5different_av[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector20vs20gs5different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector20vs20gs5different_av[i] <- -9999
  }
  else {
    hvector20vs20gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector20vs20gs5different_av, file = "hvector20vs20gs5different_av.rda")
...
#20vs20 groups, groupsize 5, different, pv

hvector20vs20gs5different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1:20],], type="raw")), mxModel(pv5different, mxData(PopDifferent[random[21:40],], type="raw")),
                         mxFitFunctionMultigroup(c("base5", "pv5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector20vs20gs5different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector20vs20gs5different_pv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector20vs20gs5different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector20vs20gs5different_pv[i] <- -9999
  }
  else {
    hvector20vs20gs5different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector20vs20gs5different_pv, file = "hvector20vs20gs5different_pv.rda")
...
#20vs20 groups, groupsize 13, different, av

hvector20vs20gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base13, mxData(PopSame[random[1:20],], type="raw")), mxModel(av13different, mxData(PopDifferent[random[21:40],], type="raw")),
                         mxFitFunctionMultigroup(c("base13", "av13different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector20vs20gs13different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector20vs20gs13different_av[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector20vs20gs13different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector20vs20gs13different_av[i] <- -9999
  }
  else {
    hvector20vs20gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector20vs20gs13different_av, file = "hvector20vs20gs13different_av.rda")
...
#20vs20 groups, groupsize 13, different, pv

hvector20vs20gs13different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base13, mxData(PopSame[random[1:20],], type="raw")), mxModel(pv13different, mxData(PopDifferent[random[21:40],], type="raw")),
                         mxFitFunctionMultigroup(c("base13", "pv13different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector20vs20gs13different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector20vs20gs13different_pv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector20vs20gs13different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector20vs20gs13different_pv[i] <- -9999
  }
  else {
    hvector20vs20gs13different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector20vs20gs13different_pv, file = "hvector20vs20gs13different_pv.rda")
...
hvector1vs5gs5different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1],], type="raw")), mxModel(rv5different, mxData(PopDifferent[random[2:6],], type="raw")),
                         mxFitFunctionMultigroup(c("base5", "rv5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector1vs5gs5different_rv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector1vs5gs5different_rv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector1vs5gs5different_rv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector1vs5gs5different_rv[i] <- -9999
  }
  else {
    hvector1vs5gs5different_rv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector1vs5gs5different_rv, file = "hvector1vs5gs5different_rv.rda")
...
hvector1vs5gs13different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base13, mxData(PopSame[random[1],], type="raw")), mxModel(rv13different, mxData(PopDifferent[random[2:6],], type="raw")),
                         mxFitFunctionMultigroup(c("base13", "rv13different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector1vs5gs13different_rv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector1vs5gs13different_rv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector1vs5gs13different_rv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector1vs5gs13different_rv[i] <- -9999
  }
  else {
    hvector1vs5gs13different_rv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector1vs5gs13different_rv, file = "hvector1vs5gs13different_rv.rda")
...
hvector5vs5gs5different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1:5],], type="raw")), mxModel(rv5different, mxData(PopDifferent[random[6:10],], type="raw")),
                         mxFitFunctionMultigroup(c("base5", "rv5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector5vs5gs5different_rv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector5vs5gs5different_rv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector5vs5gs5different_rv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector5vs5gs5different_rv[i] <- -9999
  }
  else {
    hvector5vs5gs5different_rv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector5vs5gs5different_rv, file = "hvector5vs5gs5different_rv.rda")
...
hvector5vs5gs13different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base13, mxData(PopSame[random[1:5],], type="raw")), mxModel(rv13different, mxData(PopDifferent[random[6:10],], type="raw")),
                         mxFitFunctionMultigroup(c("base13", "rv13different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector5vs5gs13different_rv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector5vs5gs13different_rv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector5vs5gs13different_rv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector5vs5gs13different_rv[i] <- -9999
  }
  else {
    hvector5vs5gs13different_rv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector5vs5gs13different_rv, file = "hvector5vs5gs13different_rv.rda")
...
hvector10vs10gs5different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1:10],], type="raw")), mxModel(rv5different, mxData(PopDifferent[random[11:20],], type="raw")),
                         mxFitFunctionMultigroup(c("base5", "rv5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector10vs10gs5different_rv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector10vs10gs5different_rv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector10vs10gs5different_rv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector10vs10gs5different_rv[i] <- -9999
  }
  else {
    hvector10vs10gs5different_rv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector10vs10gs5different_rv, file = "hvector10vs10gs5different_rv.rda")
...
hvector10vs10gs13different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base13, mxData(PopSame[random[1:10],], type="raw")), mxModel(rv13different, mxData(PopDifferent[random[11:20],], type="raw")),
                         mxFitFunctionMultigroup(c("base13", "rv13different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector10vs10gs13different_rv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector10vs10gs13different_rv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector10vs10gs13different_rv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector10vs10gs13different_rv[i] <- -9999
  }
  else {
    hvector10vs10gs13different_rv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector10vs10gs13different_rv, file = "hvector10vs10gs13different_rv.rda")
...
hvector20vs20gs5different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1:20],], type="raw")), mxModel(rv5different, mxData(PopDifferent[random[21:40],], type="raw")),
                         mxFitFunctionMultigroup(c("base5", "rv5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector20vs20gs5different_rv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector20vs20gs5different_rv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector20vs20gs5different_rv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector20vs20gs5different_rv[i] <- -9999
  }
  else {
    hvector20vs20gs5different_rv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector20vs20gs5different_rv, file = "hvector20vs20gs5different_rv.rda")
...
hvector20vs20gs13different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base13, mxData(PopSame[random[1:20],], type="raw")), mxModel(rv13different, mxData(PopDifferent[random[21:40],], type="raw")),
                         mxFitFunctionMultigroup(c("base13", "rv13different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector20vs20gs13different_rv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    hvector20vs20gs13different_rv[i] <- -8888
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector20vs20gs13different_rv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector20vs20gs13different_rv[i] <- -9999
  }
  else {
    hvector20vs20gs13different_rv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector20vs20gs13different_rv, file = "hvector20vs20gs13different_rv.rda")
...
#1vs5 groups, groupsize 5, different, apc

hvector1vs5gs5different_apc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1],], type="raw")), mxModel(other5different, mxData(PopDifferent[random[2:6],], type="raw")),
                         mxConstraint( (apc1 / (sqrt(av1)*sqrt(pv1))) == (apc2 / (sqrt(av2)*sqrt(pv2))) ),
                         mxFitFunctionMultigroup(c("base5", "other5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector1vs5gs5different_apc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector1vs5gs5different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector1vs5gs5different_apc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector1vs5gs5different_apc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector1vs5gs5different_apc[i] <- -9999
  }
  else {
    hvector1vs5gs5different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector1vs5gs5different_apc, file = "hvector1vs5gs5different_apc.rda")
...
#1vs5 groups, groupsize 5, different, rc

hvector1vs5gs5different_rc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1],], type="raw")), mxModel(other5different, mxData(PopDifferent[random[2:6],], type="raw")),
                         mxConstraint( (rc1 / (sqrt(rv1)*sqrt(rv1))) == (rc2 / (sqrt(rv2)*sqrt(rv2))) ),
                         mxFitFunctionMultigroup(c("base5", "other5different")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector1vs5gs5different_rc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector1vs5gs5different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector1vs5gs5different_rc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector1vs5gs5different_rc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector1vs5gs5different_rc[i] <- -9999
  }
  else {
    hvector1vs5gs5different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector1vs5gs5different_rc, file = "hvector1vs5gs5different_rc.rda")
...
#1vs5 groups, groupsize 13, different, apc

hvector1vs5gs13different_apc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector1vs5gs13different_apc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector1vs5gs13different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector1vs5gs13different_apc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector1vs5gs13different_apc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector1vs5gs13different_apc[i] <- -9999
  }
  else {
    hvector1vs5gs13different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector1vs5gs13different_apc, file = "hvector1vs5gs13different_apc.rda")
...
#1vs5 groups, groupsize 13, different, rc

hvector1vs5gs13different_rc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector1vs5gs13different_rc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector1vs5gs13different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector1vs5gs13different_rc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector1vs5gs13different_rc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector1vs5gs13different_rc[i] <- -9999
  }
  else {
    hvector1vs5gs13different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector1vs5gs13different_rc, file = "hvector1vs5gs13different_rc.rda")
...
#5vs5 groups, groupsize 5, different, apc

hvector5vs5gs5different_apc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector5vs5gs5different_apc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector5vs5gs5different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector5vs5gs5different_apc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector5vs5gs5different_apc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector5vs5gs5different_apc[i] <- -9999
  }
  else {
    hvector5vs5gs5different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector5vs5gs5different_apc, file = "hvector5vs5gs5different_apc.rda")
...
#5vs5 groups, groupsize 5, different, rc

hvector5vs5gs5different_rc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector5vs5gs5different_rc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector5vs5gs5different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector5vs5gs5different_rc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector5vs5gs5different_rc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector5vs5gs5different_rc[i] <- -9999
  }
  else {
    hvector5vs5gs5different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector5vs5gs5different_rc, file = "hvector5vs5gs5different_rc.rda")
...
#5vs5 groups, groupsize 13, different, apc

hvector5vs5gs13different_apc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector5vs5gs13different_apc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector5vs5gs13different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector5vs5gs13different_apc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector5vs5gs13different_apc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector5vs5gs13different_apc[i] <- -9999
  }
  else {
    hvector5vs5gs13different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector5vs5gs13different_apc, file = "hvector5vs5gs13different_apc.rda")
...
#5vs5 groups, groupsize 13, different, rc

hvector5vs5gs13different_rc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector5vs5gs13different_rc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector5vs5gs13different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector5vs5gs13different_rc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector5vs5gs13different_rc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector5vs5gs13different_rc[i] <- -9999
  }
  else {
    hvector5vs5gs13different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector5vs5gs13different_rc, file = "hvector5vs5gs13different_rc.rda")
...
#10vs10 groups, groupsize 5, different, apc

hvector10vs10gs5different_apc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector10vs10gs5different_apc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector10vs10gs5different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector10vs10gs5different_apc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector10vs10gs5different_apc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector10vs10gs5different_apc[i] <- -9999
  }
  else {
    hvector10vs10gs5different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector10vs10gs5different_apc, file = "hvector10vs10gs5different_apc.rda")
...
#10vs10 groups, groupsize 5, different, rc

hvector10vs10gs5different_rc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector10vs10gs5different_rc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector10vs10gs5different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector10vs10gs5different_rc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector10vs10gs5different_rc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector10vs10gs5different_rc[i] <- -9999
  }
  else {
    hvector10vs10gs5different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector10vs10gs5different_rc, file = "hvector10vs10gs5different_rc.rda")
...
#10vs10 groups, groupsize 13, different, apc

hvector10vs10gs13different_apc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector10vs10gs13different_apc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector10vs10gs13different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector10vs10gs13different_apc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector10vs10gs13different_apc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector10vs10gs13different_apc[i] <- -9999
  }
  else {
    hvector10vs10gs13different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector10vs10gs13different_apc, file = "hvector10vs10gs13different_apc.rda")
...
#10vs10 groups, groupsize 13, different, rc

hvector10vs10gs13different_rc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector10vs10gs13different_rc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector10vs10gs13different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector10vs10gs13different_rc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector10vs10gs13different_rc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector10vs10gs13different_rc[i] <- -9999
  }
  else {
    hvector10vs10gs13different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector10vs10gs13different_rc, file = "hvector10vs10gs13different_rc.rda")
...
#20vs20 groups, groupsize 5, different, apc

hvector20vs20gs5different_apc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector20vs20gs5different_apc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector20vs20gs5different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector20vs20gs5different_apc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector20vs20gs5different_apc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector20vs20gs5different_apc[i] <- -9999
  }
  else {
    hvector20vs20gs5different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector20vs20gs5different_apc, file = "hvector20vs20gs5different_apc.rda")
...
#20vs20 groups, groupsize 5, different, rc

hvector20vs20gs5different_rc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector20vs20gs5different_rc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector20vs20gs5different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector20vs20gs5different_rc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector20vs20gs5different_rc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector20vs20gs5different_rc[i] <- -9999
  }
  else {
    hvector20vs20gs5different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector20vs20gs5different_rc, file = "hvector20vs20gs5different_rc.rda")
...
#20vs20 groups, groupsize 13, different, apc

hvector20vs20gs13different_apc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector20vs20gs13different_apc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector20vs20gs13different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector20vs20gs13different_apc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector20vs20gs13different_apc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector20vs20gs13different_apc[i] <- -9999
  }
  else {
    hvector20vs20gs13different_apc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector20vs20gs13different_apc, file = "hvector20vs20gs13different_apc.rda")
...
#20vs20 groups, groupsize 13, different, rc

hvector20vs20gs13different_rc <- rep(NA, 3100)
...
for (i in 1:3100){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    hvector20vs20gs13different_rc[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      hvector20vs20gs13different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      hvector20vs20gs13different_rc[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    hvector20vs20gs13different_rc[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    hvector20vs20gs13different_rc[i] <- -9999
  }
  else {
    hvector20vs20gs13different_rc[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(hvector20vs20gs13different_rc, file = "hvector20vs20gs13different_rc.rda")
...
#wald tests of absolute variances

#1vs5 groups, groupsize 5, different, av

waldhvector1vs5gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector1vs5gs5different_av[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector1vs5gs5different_av[i] <- -999
  }
  
  else {
    waldhvector1vs5gs5different_av[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av1"] -
                                                summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av2"])/
                                               sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av1"] + 
                                                      vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av2", colnames(vcov(bothgroupsfit)) == "av2"] -
                                                      2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av2"]))
  }
}
save(waldhvector1vs5gs5different_av, file = "waldhvector1vs5gs5different_av.rda")
...
waldhvector1vs5gs5different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector1vs5gs5different_pv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector1vs5gs5different_pv[i] <- -999
  }
  
  else {
    waldhvector1vs5gs5different_pv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv1"] -
                                                summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv2"])/
                                               sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv1"] + 
                                                      vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv2", colnames(vcov(bothgroupsfit)) == "pv2"] -
                                                      2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv2"]))
  }
}
save(waldhvector1vs5gs5different_pv, file = "waldhvector1vs5gs5different_pv.rda")
...
waldhvector1vs5gs5different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector1vs5gs5different_rv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector1vs5gs5different_rv[i] <- -999
  }
  
  else {
    waldhvector1vs5gs5different_rv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv1"] -
                                                summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv2"])/
                                               sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv1"] + 
                                                      vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv2", colnames(vcov(bothgroupsfit)) == "rv2"] -
                                                      2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv2"]))
  }
}
save(waldhvector1vs5gs5different_rv, file = "waldhvector1vs5gs5different_rv.rda")
...
waldhvector1vs5gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector1vs5gs13different_av[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector1vs5gs13different_av[i] <- -999
  }
  
  else {
    waldhvector1vs5gs13different_av[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av1"] -
                                                 summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av2"])/
                                                sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av1"] + 
                                                       vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av2", colnames(vcov(bothgroupsfit)) == "av2"] -
                                                       2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av2"]))
...
save(waldhvector1vs5gs13different_av, file = "waldhvector1vs5gs13different_av.rda")
...
waldhvector1vs5gs13different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector1vs5gs13different_pv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector1vs5gs13different_pv[i] <- -999
  }
  
  else {
    waldhvector1vs5gs13different_pv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv1"] -
                                                 summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv2"])/
                                                sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv1"] + 
                                                       vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv2", colnames(vcov(bothgroupsfit)) == "pv2"] -
                                                       2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv2"]))
...
save(waldhvector1vs5gs13different_pv, file = "waldhvector1vs5gs13different_pv.rda")
...
waldhvector1vs5gs13different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector1vs5gs13different_rv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector1vs5gs13different_rv[i] <- -999
  }
  
  else {
    waldhvector1vs5gs13different_rv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv1"] -
                                                 summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv2"])/
                                                sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv1"] + 
                                                       vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv2", colnames(vcov(bothgroupsfit)) == "rv2"] -
                                                       2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv2"]))
...
save(waldhvector1vs5gs13different_rv, file = "waldhvector1vs5gs13different_rv.rda")
...
waldhvector5vs5gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector5vs5gs5different_av[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector5vs5gs5different_av[i] <- -999
  }
  
  else {
    waldhvector5vs5gs5different_av[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av1"] -
                                                summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av2"])/
                                               sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av1"] + 
                                                      vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av2", colnames(vcov(bothgroupsfit)) == "av2"] -
                                                      2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av2"]))
...
save(waldhvector5vs5gs5different_av, file = "waldhvector5vs5gs5different_av.rda")
...
waldhvector5vs5gs5different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector5vs5gs5different_pv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector5vs5gs5different_pv[i] <- -999
  }
  
  else {
    waldhvector5vs5gs5different_pv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv1"] -
                                                summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv2"])/
                                               sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv1"] + 
                                                      vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv2", colnames(vcov(bothgroupsfit)) == "pv2"] -
                                                      2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv2"]))
...
save(waldhvector5vs5gs5different_pv, file = "waldhvector5vs5gs5different_pv.rda")
...
waldhvector5vs5gs5different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector5vs5gs5different_rv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector5vs5gs5different_rv[i] <- -999
  }
  
  else {
    waldhvector5vs5gs5different_rv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv1"] -
                                                summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv2"])/
                                               sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv1"] + 
                                                      vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv2", colnames(vcov(bothgroupsfit)) == "rv2"] -
                                                      2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv2"]))
...
save(waldhvector5vs5gs5different_rv, file = "waldhvector5vs5gs5different_rv.rda")
...
waldhvector5vs5gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector5vs5gs13different_av[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector5vs5gs13different_av[i] <- -999
  }
  
  else {
    waldhvector5vs5gs13different_av[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av1"] -
                                                 summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av2"])/
                                                sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av1"] + 
                                                       vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av2", colnames(vcov(bothgroupsfit)) == "av2"] -
                                                       2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av2"]))
...
save(waldhvector5vs5gs13different_av, file = "waldhvector5vs5gs13different_av.rda")
...
waldhvector5vs5gs13different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector5vs5gs13different_pv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector5vs5gs13different_pv[i] <- -999
  }
  
  else {
    waldhvector5vs5gs13different_pv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv1"] -
                                                 summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv2"])/
                                                sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv1"] + 
                                                       vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv2", colnames(vcov(bothgroupsfit)) == "pv2"] -
                                                       2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv2"]))
...
save(waldhvector5vs5gs13different_pv, file = "waldhvector5vs5gs13different_pv.rda")
...
waldhvector5vs5gs13different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector5vs5gs13different_rv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector5vs5gs13different_rv[i] <- -999
  }
  
  else {
    waldhvector5vs5gs13different_rv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv1"] -
                                                 summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv2"])/
                                                sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv1"] + 
                                                       vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv2", colnames(vcov(bothgroupsfit)) == "rv2"] -
                                                       2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv2"]))
...
save(waldhvector5vs5gs13different_rv, file = "waldhvector5vs5gs13different_rv.rda")
...
waldhvector10vs10gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector10vs10gs5different_av[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector10vs10gs5different_av[i] <- -999
  }
  
  else {
    waldhvector10vs10gs5different_av[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av1"] -
                                                  summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av2"])/
                                                 sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av1"] + 
                                                        vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av2", colnames(vcov(bothgroupsfit)) == "av2"] -
                                                        2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av2"]))
...
save(waldhvector10vs10gs5different_av, file = "waldhvector10vs10gs5different_av.rda")
...
waldhvector10vs10gs5different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector10vs10gs5different_pv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector10vs10gs5different_pv[i] <- -999
  }
  
  else {
    waldhvector10vs10gs5different_pv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv1"] -
                                                  summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv2"])/
                                                 sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv1"] + 
                                                        vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv2", colnames(vcov(bothgroupsfit)) == "pv2"] -
                                                        2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv2"]))
...
save(waldhvector10vs10gs5different_pv, file = "waldhvector10vs10gs5different_pv.rda")
...
waldhvector10vs10gs5different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector10vs10gs5different_rv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector10vs10gs5different_rv[i] <- -999
  }
  
  else {
    waldhvector10vs10gs5different_rv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv1"] -
                                                  summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv2"])/
                                                 sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv1"] + 
                                                        vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv2", colnames(vcov(bothgroupsfit)) == "rv2"] -
                                                        2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv2"]))
...
save(waldhvector10vs10gs5different_rv, file = "waldhvector10vs10gs5different_rv.rda")
...
waldhvector10vs10gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector10vs10gs13different_av[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector10vs10gs13different_av[i] <- -999
  }
  
  else {
    waldhvector10vs10gs13different_av[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av1"] -
                                                   summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av2"])/
                                                  sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av1"] + 
                                                         vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av2", colnames(vcov(bothgroupsfit)) == "av2"] -
                                                         2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av2"]))
...
save(waldhvector10vs10gs13different_av, file = "waldhvector10vs10gs13different_av.rda")
...
waldhvector10vs10gs13different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector10vs10gs13different_pv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector10vs10gs13different_pv[i] <- -999
  }
  
  else {
    waldhvector10vs10gs13different_pv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv1"] -
                                                   summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv2"])/
                                                  sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv1"] + 
                                                         vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv2", colnames(vcov(bothgroupsfit)) == "pv2"] -
                                                         2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv2"]))
...
save(waldhvector10vs10gs13different_pv, file = "waldhvector10vs10gs13different_pv.rda")
...
waldhvector10vs10gs13different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector10vs10gs13different_rv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector10vs10gs13different_rv[i] <- -999
  }
  
  else {
    waldhvector10vs10gs13different_rv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv1"] -
                                                   summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv2"])/
                                                  sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv1"] + 
                                                         vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv2", colnames(vcov(bothgroupsfit)) == "rv2"] -
                                                         2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv2"]))
...
save(waldhvector10vs10gs13different_rv, file = "waldhvector10vs10gs13different_rv.rda")
...
waldhvector20vs20gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector20vs20gs5different_av[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector20vs20gs5different_av[i] <- -999
  }
  
  else {
    waldhvector20vs20gs5different_av[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av1"] -
                                                  summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av2"])/
                                                 sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av1"] + 
                                                        vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av2", colnames(vcov(bothgroupsfit)) == "av2"] -
                                                        2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av2"]))
...
save(waldhvector20vs20gs5different_av, file = "waldhvector20vs20gs5different_av.rda")
...
waldhvector20vs20gs5different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector20vs20gs5different_pv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector20vs20gs5different_pv[i] <- -999
  }
  
  else {
    waldhvector20vs20gs5different_pv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv1"] -
                                                  summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv2"])/
                                                 sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv1"] + 
                                                        vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv2", colnames(vcov(bothgroupsfit)) == "pv2"] -
                                                        2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv2"]))
...
save(waldhvector20vs20gs5different_pv, file = "waldhvector20vs20gs5different_pv.rda")
...
waldhvector20vs20gs5different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector20vs20gs5different_rv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector20vs20gs5different_rv[i] <- -999
  }
  
  else {
    waldhvector20vs20gs5different_rv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv1"] -
                                                  summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv2"])/
                                                 sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv1"] + 
                                                        vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv2", colnames(vcov(bothgroupsfit)) == "rv2"] -
                                                        2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv2"]))
...
save(waldhvector20vs20gs5different_rv, file = "waldhvector20vs20gs5different_rv.rda")
...
waldhvector20vs20gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector20vs20gs13different_av[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector20vs20gs13different_av[i] <- -999
  }
  
  else {
    waldhvector20vs20gs13different_av[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av1"] -
                                                   summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "av2"])/
                                                  sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av1"] + 
                                                         vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av2", colnames(vcov(bothgroupsfit)) == "av2"] -
                                                         2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "av1", colnames(vcov(bothgroupsfit)) == "av2"]))
...
save(waldhvector20vs20gs13different_av, file = "waldhvector20vs20gs13different_av.rda")
...
waldhvector20vs20gs13different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector20vs20gs13different_pv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector20vs20gs13different_pv[i] <- -999
  }
  
  else {
    waldhvector20vs20gs13different_pv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv1"] -
                                                   summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "pv2"])/
                                                  sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv1"] + 
                                                         vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv2", colnames(vcov(bothgroupsfit)) == "pv2"] -
                                                         2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "pv1", colnames(vcov(bothgroupsfit)) == "pv2"]))
...
save(waldhvector20vs20gs13different_pv, file = "waldhvector20vs20gs13different_pv.rda")
...
waldhvector20vs20gs13different_rv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    waldhvector20vs20gs13different_rv[i] <- -888
  }
  
  else if (length(is(bothgroupsfit)) >  2){
    waldhvector20vs20gs13different_rv[i] <- -999
  }
  
  else {
    waldhvector20vs20gs13different_rv[i] <- abs((summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv1"] -
                                                   summary(bothgroupsfit)[3]$parameters$Estimate[summary(bothgroupsfit)[3]$parameters$name == "rv2"])/
                                                  sqrt(vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv1"] + 
                                                         vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv2", colnames(vcov(bothgroupsfit)) == "rv2"] -
                                                         2*vcov(bothgroupsfit)[rownames(vcov(bothgroupsfit)) == "rv1", colnames(vcov(bothgroupsfit)) == "rv2"]))
...
save(waldhvector20vs20gs13different_rv, file = "waldhvector20vs20gs13different_rv.rda")
