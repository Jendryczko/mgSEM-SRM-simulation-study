...
generalPartnerVar <- .15
generalRelationshipVar <- .5
generalActorPartnerCov <- .03674235  #(implying correlation of .2)
generalRelationshipCov <- .05        #(implying correlation of .1)
...
differentActorVar <- .225
differentPartnerVar <- .15
differentRelationshipVar <- .5
differentActorPartnerCov <- .03674235  #(implying correlation of .2)
...
#1vs5 groups, groupsize 5, same, avpv

propnmavector1vs5gs5same_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroups <- mxModel("bothgroups",
                        mxModel(base5, mxData(PopSame[random[1],], type="raw")), mxModel(other5same, mxData(PopSame[random[2:6],], type="raw")),
                        mxFitFunctionMultigroup(c("base5", "other5same")))
  
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1],], type="raw")), mxModel(other5same, mxData(PopSame[random[2:6],], type="raw")),
                         mxConstraint( (av1 / (av1 + pv1)) == (av2 / (av2 + pv2)) ),
                         mxFitFunctionMultigroup(c("base5", "other5same")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector1vs5gs5same_avpv[i] <- -888
  }
    ...
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector1vs5gs5same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector1vs5gs5same_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector1vs5gs5same_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector1vs5gs5same_avpv[i] <- -9999
  }
  else {
    propnmavector1vs5gs5same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector1vs5gs5same_avpv, file = "propnmavector1vs5gs5same_avpv.rda")
...
#1vs5 groups, groupsize 5, different, avpv

propnmavector1vs5gs5different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector1vs5gs5different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector1vs5gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector1vs5gs5different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector1vs5gs5different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector1vs5gs5different_avpv[i] <- -9999
  }
  else {
    propnmavector1vs5gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector1vs5gs5different_avpv, file = "propnmavector1vs5gs5different_avpv.rda")


############################################################################################################################


#1vs5 groups, groupsize 13, same, avpv

propnmavector1vs5gs13same_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroups <- mxModel("bothgroups",
                        mxModel(base13, mxData(PopSame[random[1],], type="raw")), mxModel(other13same, mxData(PopSame[random[2:6],], type="raw")),
                        mxFitFunctionMultigroup(c("base13", "other13same")))
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector1vs5gs13same_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector1vs5gs13same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector1vs5gs13same_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector1vs5gs13same_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector1vs5gs13same_avpv[i] <- -9999
  }
  else {
    propnmavector1vs5gs13same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector1vs5gs13same_avpv, file = "propnmavector1vs5gs13same_avpv.rda")
...
#1vs5 groups, groupsize 13, different, avpv

propnmavector1vs5gs13different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector1vs5gs13different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector1vs5gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector1vs5gs13different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector1vs5gs13different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector1vs5gs13different_avpv[i] <- -9999
  }
  else {
    propnmavector1vs5gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector1vs5gs13different_avpv, file = "propnmavector1vs5gs13different_avpv.rda")
...
#5vs5 groups, groupsize 5, same, avpv

propnmavector5vs5gs5same_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroups <- mxModel("bothgroups",
                        mxModel(base5, mxData(PopSame[random[1:5],], type="raw")), mxModel(other5same, mxData(PopSame[random[6:10],], type="raw")),
                        mxFitFunctionMultigroup(c("base5", "other5same")))
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector5vs5gs5same_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector5vs5gs5same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector5vs5gs5same_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector5vs5gs5same_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector5vs5gs5same_avpv[i] <- -9999
  }
  else {
    propnmavector5vs5gs5same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector5vs5gs5same_avpv, file = "propnmavector5vs5gs5same_avpv.rda")
...
#5vs5 groups, groupsize 5, different, avpv

propnmavector5vs5gs5different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector5vs5gs5different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector5vs5gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector5vs5gs5different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector5vs5gs5different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector5vs5gs5different_avpv[i] <- -9999
  }
  else {
    propnmavector5vs5gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector5vs5gs5different_avpv, file = "propnmavector5vs5gs5different_avpv.rda")


############################################################################################################################


#5vs5 groups, groupsize 13, same, avpv

propnmavector5vs5gs13same_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroups <- mxModel("bothgroups",
                        mxModel(base13, mxData(PopSame[random[1:5],], type="raw")), mxModel(other13same, mxData(PopSame[random[6:10],], type="raw")),
                        mxFitFunctionMultigroup(c("base13", "other13same")))
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector5vs5gs13same_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector5vs5gs13same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector5vs5gs13same_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector5vs5gs13same_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector5vs5gs13same_avpv[i] <- -9999
  }
  else {
    propnmavector5vs5gs13same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector5vs5gs13same_avpv, file = "propnmavector5vs5gs13same_avpv.rda")


############################################################################################################################


#5vs5 groups, groupsize 13, different, avpv

propnmavector5vs5gs13different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector5vs5gs13different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector5vs5gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector5vs5gs13different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector5vs5gs13different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector5vs5gs13different_avpv[i] <- -9999
  }
  else {
    propnmavector5vs5gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector5vs5gs13different_avpv, file = "propnmavector5vs5gs13different_avpv.rda")


############################################################################################################################


#10vs10 groups, groupsize 5, same, avpv

propnmavector10vs10gs5same_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroups <- mxModel("bothgroups",
                        mxModel(base5, mxData(PopSame[random[1:10],], type="raw")), mxModel(other5same, mxData(PopSame[random[11:20],], type="raw")),
                        mxFitFunctionMultigroup(c("base5", "other5same")))
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector10vs10gs5same_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector10vs10gs5same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector10vs10gs5same_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector10vs10gs5same_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector10vs10gs5same_avpv[i] <- -9999
  }
  else {
    propnmavector10vs10gs5same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector10vs10gs5same_avpv, file = "propnmavector10vs10gs5same_avpv.rda")


############################################################################################################################


#10vs10 groups, groupsize 5, different, avpv

propnmavector10vs10gs5different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector10vs10gs5different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector10vs10gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector10vs10gs5different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector10vs10gs5different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector10vs10gs5different_avpv[i] <- -9999
  }
  else {
    propnmavector10vs10gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector10vs10gs5different_avpv, file = "propnmavector10vs10gs5different_avpv.rda")


############################################################################################################################


#10vs10 groups, groupsize 13, same, avpv

propnmavector10vs10gs13same_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroups <- mxModel("bothgroups",
                        mxModel(base13, mxData(PopSame[random[1:10],], type="raw")), mxModel(other13same, mxData(PopSame[random[11:20],], type="raw")),
                        mxFitFunctionMultigroup(c("base13", "other13same")))
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector10vs10gs13same_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector10vs10gs13same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector10vs10gs13same_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector10vs10gs13same_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector10vs10gs13same_avpv[i] <- -9999
  }
  else {
    propnmavector10vs10gs13same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector10vs10gs13same_avpv, file = "propnmavector10vs10gs13same_avpv.rda")
...
#10vs10 groups, groupsize 13, different, avpv

propnmavector10vs10gs13different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector10vs10gs13different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector10vs10gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector10vs10gs13different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector10vs10gs13different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector10vs10gs13different_avpv[i] <- -9999
  }
  else {
    propnmavector10vs10gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector10vs10gs13different_avpv, file = "propnmavector10vs10gs13different_avpv.rda")
...
#20vs20 groups, groupsize 5, same, avpv

propnmavector20vs20gs5same_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroups <- mxModel("bothgroups",
                        mxModel(base5, mxData(PopSame[random[1:20],], type="raw")), mxModel(other5same, mxData(PopSame[random[21:40],], type="raw")),
                        mxFitFunctionMultigroup(c("base5", "other5same")))
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector20vs20gs5same_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector20vs20gs5same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector20vs20gs5same_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector20vs20gs5same_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector20vs20gs5same_avpv[i] <- -9999
  }
  else {
    propnmavector20vs20gs5same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector20vs20gs5same_avpv, file = "propnmavector20vs20gs5same_avpv.rda")
...
#20vs20 groups, groupsize 5, different, avpv

propnmavector20vs20gs5different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector20vs20gs5different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector20vs20gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector20vs20gs5different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector20vs20gs5different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector20vs20gs5different_avpv[i] <- -9999
  }
  else {
    propnmavector20vs20gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector20vs20gs5different_avpv, file = "propnmavector20vs20gs5different_avpv.rda")

#########################################################################################################################



#20vs20 groups, groupsize 13, same, avpv

propnmavector20vs20gs13same_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroups <- mxModel("bothgroups",
                        mxModel(base13, mxData(PopSame[random[1:20],], type="raw")), mxModel(other13same, mxData(PopSame[random[21:40],], type="raw")),
                        mxFitFunctionMultigroup(c("base13", "other13same")))
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector20vs20gs13same_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector20vs20gs13same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector20vs20gs13same_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector20vs20gs13same_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector20vs20gs13same_avpv[i] <- -9999
  }
  else {
    propnmavector20vs20gs13same_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector20vs20gs13same_avpv, file = "propnmavector20vs20gs13same_avpv.rda")
...
#20vs20 groups, groupsize 13, different, avpv

propnmavector20vs20gs13different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector20vs20gs13different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector20vs20gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector20vs20gs13different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector20vs20gs13different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector20vs20gs13different_avpv[i] <- -9999
  }
  else {
    propnmavector20vs20gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector20vs20gs13different_avpv, file = "propnmavector20vs20gs13different_avpv.rda")
