...
generalActorVar <- .35
generalPartnerVar <- .06608391
generalRelationshipVar <- .2202797
generalActorPartnerCov <- .03041669  #(implying correlation of .2)
generalRelationshipCov <- .02202797  #(implying correlation of .1)
...
differentPartnerVar <- .06608391
differentRelationshipVar <- .2202797
differentActorPartnerCov <- .03041669  #(implying correlation of .2)
differentRelationshipCov <- .02202797  #(implying correlation of .1)
...
prophvector1vs5gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector1vs5gs5different_av[i] <- -888
  }
    ...
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector1vs5gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector1vs5gs5different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector1vs5gs5different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector1vs5gs5different_av[i] <- -9999
  }
  else {
    prophvector1vs5gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector1vs5gs5different_av, file = "prophvector1vs5gs5different_av.rda")
...
prophvector1vs5gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector1vs5gs13different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector1vs5gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector1vs5gs13different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector1vs5gs13different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector1vs5gs13different_av[i] <- -9999
  }
  else {
    prophvector1vs5gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector1vs5gs13different_av, file = "prophvector1vs5gs13different_av.rda")
...
prophvector5vs5gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector5vs5gs5different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector5vs5gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector5vs5gs5different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector5vs5gs5different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector5vs5gs5different_av[i] <- -9999
  }
  else {
    prophvector5vs5gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector5vs5gs5different_av, file = "prophvector5vs5gs5different_av.rda")
...
prophvector5vs5gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector5vs5gs13different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector5vs5gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector5vs5gs13different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector5vs5gs13different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector5vs5gs13different_av[i] <- -9999
  }
  else {
    prophvector5vs5gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector5vs5gs13different_av, file = "prophvector5vs5gs13different_av.rda")
...
prophvector10vs10gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector10vs10gs5different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector10vs10gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector10vs10gs5different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector10vs10gs5different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector10vs10gs5different_av[i] <- -9999
  }
  else {
    prophvector10vs10gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector10vs10gs5different_av, file = "prophvector10vs10gs5different_av.rda")
...
prophvector10vs10gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector10vs10gs13different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector10vs10gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector10vs10gs13different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector10vs10gs13different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector10vs10gs13different_av[i] <- -9999
  }
  else {
    prophvector10vs10gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector10vs10gs13different_av, file = "prophvector10vs10gs13different_av.rda")
...
prophvector20vs20gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector20vs20gs5different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector20vs20gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector20vs20gs5different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector20vs20gs5different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector20vs20gs5different_av[i] <- -9999
  }
  else {
    prophvector20vs20gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector20vs20gs5different_av, file = "prophvector20vs20gs5different_av.rda")
...
prophvector20vs20gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector20vs20gs13different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector20vs20gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector20vs20gs13different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector20vs20gs13different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector20vs20gs13different_av[i] <- -9999
  }
  else {
    prophvector20vs20gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector20vs20gs13different_av, file = "prophvector20vs20gs13different_av.rda")
