...
generalActorVar <- .1147059
generalPartnerVar <- .15
generalRelationshipVar <- .1638655
generalActorPartnerCov <- .02623424  #(implying correlation of .2)
generalRelationshipCov <- .01638655  #(implying correlation of .1)
...
differentActorVar <- .1147059
differentPartnerVar <- .15
differentRelationshipVar <- .1638655
differentActorPartnerCov <- .02623424  #(implying correlation of .2)
differentRelationshipCov <- .01638655  #(implying correlation of .1)
...
prophvector1vs5gs5different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector1vs5gs5different_pv[i] <- -888
  }
    ...
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector1vs5gs5different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector1vs5gs5different_pv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector1vs5gs5different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector1vs5gs5different_pv[i] <- -9999
  }
  else {
    prophvector1vs5gs5different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector1vs5gs5different_pv, file = "prophvector1vs5gs5different_pv.rda")
...
prophvector1vs5gs13different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector1vs5gs13different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector1vs5gs13different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector1vs5gs13different_pv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector1vs5gs13different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector1vs5gs13different_pv[i] <- -9999
  }
  else {
    prophvector1vs5gs13different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector1vs5gs13different_pv, file = "prophvector1vs5gs13different_pv.rda")
...
prophvector5vs5gs5different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector5vs5gs5different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector5vs5gs5different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector5vs5gs5different_pv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector5vs5gs5different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector5vs5gs5different_pv[i] <- -9999
  }
  else {
    prophvector5vs5gs5different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector5vs5gs5different_pv, file = "prophvector5vs5gs5different_pv.rda")
...
prophvector5vs5gs13different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector5vs5gs13different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector5vs5gs13different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector5vs5gs13different_pv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector5vs5gs13different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector5vs5gs13different_pv[i] <- -9999
  }
  else {
    prophvector5vs5gs13different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector5vs5gs13different_pv, file = "prophvector5vs5gs13different_pv.rda")
...
prophvector10vs10gs5different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector10vs10gs5different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector10vs10gs5different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector10vs10gs5different_pv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector10vs10gs5different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector10vs10gs5different_pv[i] <- -9999
  }
  else {
    prophvector10vs10gs5different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector10vs10gs5different_pv, file = "prophvector10vs10gs5different_pv.rda")
...
prophvector10vs10gs13different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector10vs10gs13different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector10vs10gs13different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector10vs10gs13different_pv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector10vs10gs13different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector10vs10gs13different_pv[i] <- -9999
  }
  else {
    prophvector10vs10gs13different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector10vs10gs13different_pv, file = "prophvector10vs10gs13different_pv.rda")
...
prophvector20vs20gs5different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector20vs20gs5different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector20vs20gs5different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector20vs20gs5different_pv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector20vs20gs5different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector20vs20gs5different_pv[i] <- -9999
  }
  else {
    prophvector20vs20gs5different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector20vs20gs5different_pv, file = "prophvector20vs20gs5different_pv.rda")
...
prophvector20vs20gs13different_pv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector20vs20gs13different_pv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector20vs20gs13different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector20vs20gs13different_pv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector20vs20gs13different_pv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector20vs20gs13different_pv[i] <- -9999
  }
  else {
    prophvector20vs20gs13different_pv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector20vs20gs13different_pv, file = "prophvector20vs20gs13different_pv.rda")
