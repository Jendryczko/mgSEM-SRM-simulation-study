...
generalActorVar <- .35
generalPartnerVar <- .09871795
generalRelationshipVar <- .3290598
generalActorPartnerCov <- .03717595  #(implying correlation of .2)
generalRelationshipCov <- .03290598  #(implying correlation of .1)
...
differentActorVar <- .35
differentPartnerVar <- .09871795
differentRelationshipVar <- .3290598
differentActorPartnerCov <- .03717595  #(implying correlation of .2)
differentRelationshipCov <- .03290598  #(implying correlation of .1)
...
#1vs5 groups, groupsize 5, same, av

propnmavector1vs5gs5same_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  bothgroupse <- mxModel("bothgroupse",
                         mxModel(base5, mxData(PopSame[random[1],], type="raw")), mxModel(other5same, mxData(PopSame[random[2:6],], type="raw")),
                         mxConstraint( (av1 / (av1 + pv1 +rv1)) == (av2 / (av2 + pv2 +rv2)) ),
                         mxFitFunctionMultigroup(c("base5", "other5same")))
  
  
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector1vs5gs5same_av[i] <- -888
  }
    ...
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector1vs5gs5same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector1vs5gs5same_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector1vs5gs5same_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector1vs5gs5same_av[i] <- -9999
  }
  else {
    propnmavector1vs5gs5same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector1vs5gs5same_av, file = "propnmavector1vs5gs5same_av.rda")
...
propnmavector1vs5gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector1vs5gs5different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector1vs5gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector1vs5gs5different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector1vs5gs5different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector1vs5gs5different_av[i] <- -9999
  }
  else {
    propnmavector1vs5gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector1vs5gs5different_av, file = "propnmavector1vs5gs5different_av.rda")


############################################################################################################################


#1vs5 groups, groupsize 13, same, av

propnmavector1vs5gs13same_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector1vs5gs13same_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector1vs5gs13same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector1vs5gs13same_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector1vs5gs13same_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector1vs5gs13same_av[i] <- -9999
  }
  else {
    propnmavector1vs5gs13same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector1vs5gs13same_av, file = "propnmavector1vs5gs13same_av.rda")
...
propnmavector1vs5gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector1vs5gs13different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector1vs5gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector1vs5gs13different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector1vs5gs13different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector1vs5gs13different_av[i] <- -9999
  }
  else {
    propnmavector1vs5gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector1vs5gs13different_av, file = "propnmavector1vs5gs13different_av.rda")
...
#5vs5 groups, groupsize 5, same, av

propnmavector5vs5gs5same_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector5vs5gs5same_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector5vs5gs5same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector5vs5gs5same_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector5vs5gs5same_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector5vs5gs5same_av[i] <- -9999
  }
  else {
    propnmavector5vs5gs5same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector5vs5gs5same_av, file = "propnmavector5vs5gs5same_av.rda")
...
propnmavector5vs5gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector5vs5gs5different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector5vs5gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector5vs5gs5different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector5vs5gs5different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector5vs5gs5different_av[i] <- -9999
  }
  else {
    propnmavector5vs5gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector5vs5gs5different_av, file = "propnmavector5vs5gs5different_av.rda")


############################################################################################################################


#5vs5 groups, groupsize 13, same, av

propnmavector5vs5gs13same_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector5vs5gs13same_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector5vs5gs13same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector5vs5gs13same_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector5vs5gs13same_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector5vs5gs13same_av[i] <- -9999
  }
  else {
    propnmavector5vs5gs13same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector5vs5gs13same_av, file = "propnmavector5vs5gs13same_av.rda")
...
propnmavector5vs5gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector5vs5gs13different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector5vs5gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector5vs5gs13different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector5vs5gs13different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector5vs5gs13different_av[i] <- -9999
  }
  else {
    propnmavector5vs5gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector5vs5gs13different_av, file = "propnmavector5vs5gs13different_av.rda")


############################################################################################################################


#10vs10 groups, groupsize 5, same, av

propnmavector10vs10gs5same_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector10vs10gs5same_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector10vs10gs5same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector10vs10gs5same_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector10vs10gs5same_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector10vs10gs5same_av[i] <- -9999
  }
  else {
    propnmavector10vs10gs5same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector10vs10gs5same_av, file = "propnmavector10vs10gs5same_av.rda")
...
propnmavector10vs10gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector10vs10gs5different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector10vs10gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector10vs10gs5different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector10vs10gs5different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector10vs10gs5different_av[i] <- -9999
  }
  else {
    propnmavector10vs10gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector10vs10gs5different_av, file = "propnmavector10vs10gs5different_av.rda")


############################################################################################################################


#10vs10 groups, groupsize 13, same, av

propnmavector10vs10gs13same_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector10vs10gs13same_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector10vs10gs13same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector10vs10gs13same_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector10vs10gs13same_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector10vs10gs13same_av[i] <- -9999
  }
  else {
    propnmavector10vs10gs13same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector10vs10gs13same_av, file = "propnmavector10vs10gs13same_av.rda")
...
propnmavector10vs10gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector10vs10gs13different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector10vs10gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector10vs10gs13different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector10vs10gs13different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector10vs10gs13different_av[i] <- -9999
  }
  else {
    propnmavector10vs10gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector10vs10gs13different_av, file = "propnmavector10vs10gs13different_av.rda")
...
#20vs20 groups, groupsize 5, same, av

propnmavector20vs20gs5same_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector20vs20gs5same_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector20vs20gs5same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector20vs20gs5same_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector20vs20gs5same_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector20vs20gs5same_av[i] <- -9999
  }
  else {
    propnmavector20vs20gs5same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector20vs20gs5same_av, file = "propnmavector20vs20gs5same_av.rda")
...
propnmavector20vs20gs5different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector20vs20gs5different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector20vs20gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector20vs20gs5different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector20vs20gs5different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector20vs20gs5different_av[i] <- -9999
  }
  else {
    propnmavector20vs20gs5different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector20vs20gs5different_av, file = "propnmavector20vs20gs5different_av.rda")

#########################################################################################################################



#20vs20 groups, groupsize 13, same, av

propnmavector20vs20gs13same_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector20vs20gs13same_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector20vs20gs13same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector20vs20gs13same_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector20vs20gs13same_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector20vs20gs13same_av[i] <- -9999
  }
  else {
    propnmavector20vs20gs13same_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector20vs20gs13same_av, file = "propnmavector20vs20gs13same_av.rda")
...
propnmavector20vs20gs13different_av <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    propnmavector20vs20gs13different_av[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      propnmavector20vs20gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      propnmavector20vs20gs13different_av[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    propnmavector20vs20gs13different_av[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    propnmavector20vs20gs13different_av[i] <- -9999
  }
  else {
    propnmavector20vs20gs13different_av[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(propnmavector20vs20gs13different_av, file = "propnmavector20vs20gs13different_av.rda")
