...
generalPartnerVar <- .15
generalRelationshipVar <- .5
generalActorPartnerCov <- .03        #(implying correlation of .2)
generalRelationshipCov <- .05        #(implying correlation of .1)
...
differentActorPartnerCov <- .03        #(implying correlation of .2)
...
prophvector1vs5gs5different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector1vs5gs5different_avpv[i] <- -888
  }
    ...
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector1vs5gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector1vs5gs5different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector1vs5gs5different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector1vs5gs5different_avpv[i] <- -9999
  }
  else {
    prophvector1vs5gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector1vs5gs5different_avpv, file = "prophvector1vs5gs5different_avpv.rda")
...
prophvector1vs5gs13different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector1vs5gs13different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector1vs5gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector1vs5gs13different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector1vs5gs13different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector1vs5gs13different_avpv[i] <- -9999
  }
  else {
    prophvector1vs5gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector1vs5gs13different_avpv, file = "prophvector1vs5gs13different_avpv.rda")
...
prophvector5vs5gs5different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector5vs5gs5different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector5vs5gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector5vs5gs5different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector5vs5gs5different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector5vs5gs5different_avpv[i] <- -9999
  }
  else {
    prophvector5vs5gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector5vs5gs5different_avpv, file = "prophvector5vs5gs5different_avpv.rda")
...
prophvector5vs5gs13different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector5vs5gs13different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector5vs5gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector5vs5gs13different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector5vs5gs13different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector5vs5gs13different_avpv[i] <- -9999
  }
  else {
    prophvector5vs5gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector5vs5gs13different_avpv, file = "prophvector5vs5gs13different_avpv.rda")
...
prophvector10vs10gs5different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector10vs10gs5different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector10vs10gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector10vs10gs5different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector10vs10gs5different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector10vs10gs5different_avpv[i] <- -9999
  }
  else {
    prophvector10vs10gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector10vs10gs5different_avpv, file = "prophvector10vs10gs5different_avpv.rda")
...
prophvector10vs10gs13different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector10vs10gs13different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector10vs10gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector10vs10gs13different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector10vs10gs13different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector10vs10gs13different_avpv[i] <- -9999
  }
  else {
    prophvector10vs10gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector10vs10gs13different_avpv, file = "prophvector10vs10gs13different_avpv.rda")
...
prophvector20vs20gs5different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector20vs20gs5different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector20vs20gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector20vs20gs5different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector20vs20gs5different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector20vs20gs5different_avpv[i] <- -9999
  }
  else {
    prophvector20vs20gs5different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector20vs20gs5different_avpv, file = "prophvector20vs20gs5different_avpv.rda")
...
prophvector20vs20gs13different_avpv <- rep(NA, 1300)
...
for (i in 1:1300){
  ...
  if (has_warning(bothgroupsfit <- mxRunDave(bothgroups)) == T){
    prophvector20vs20gs13different_avpv[i] <- -888
  }
  else if (has_warning(bothgroupsefit <- mxRunDave(bothgroupse)) == T){
    if (grepl("optimality conditions to the required accuracy", summary(bothgroupsefit)[39]$npsolMessage) ==T){
      prophvector20vs20gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
    }
    else {
      prophvector20vs20gs13different_avpv[i] <- -8888}
  }
  else if (length(is(bothgroupsfit)) >  2){
    prophvector20vs20gs13different_avpv[i] <- -999
  }
  else if (length(is(bothgroupsefit)) >  2){
    prophvector20vs20gs13different_avpv[i] <- -9999
  }
  else {
    prophvector20vs20gs13different_avpv[i] <- summary(bothgroupsefit)[8]$Minus2LogLikelihood - summary(bothgroupsfit)[8]$Minus2LogLikelihood
  }
}
save(prophvector20vs20gs13different_avpv, file = "prophvector20vs20gs13different_avpv.rda")
